  ...
  return (
    <div className='group relative flex cursor-pointer'>
      <motion.img
        ...
        className='rounded-full border-[2px] border-[#EC9EC0]
        object-cover w-20 h-20 md:w-22 md:h-22 xl:w-24 xl:h-24
      ...
      opacity-0 group-hover:opacity-100 group-hover:bg-[#EC9EC0]/60 z-0
      transition duration-400 ease-in-out group-hover:animate-bounce'>
        <div className='flex items-center justify-center h-full'>
          <p className='text-2xl font-bold text-[#FF0080] opacity-100'>100%</p>
        </div>
      </div>
    </div>
  );
